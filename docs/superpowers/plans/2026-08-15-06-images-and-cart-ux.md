...
- [ ] 6. Commits: `feat(cart): optimistic qty steppers and live badge (tokachi pattern)`, then UI-polish commit if needed. Do NOT push (controller browser-reviews first).
